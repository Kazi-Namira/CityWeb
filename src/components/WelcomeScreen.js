...
// import ecoCity from "../assets/eco-city-bg.jpg";

// export default function WelcomeScreen() {
//   return (
//     <div className="flex items-center justify-center min-h-screen">
//       <div className=" bg-green-500 rounded-3xl shadow-xl w-[350px] p-8 flex flex-col items-center opacity-90">
//         {/* Logo */}
//         <div className="mb-4">
//           {
//             /* <svg
...
//               d="M12 21c4.97-5.33 8-9.33 8-12a8 8 0 00-16 0c0 2.67 3.03 6.67 8 12z"
//             />
//           </svg> */
//             <svg
//               xmlns="http://www.w3.org/2000/svg"
...
//           {/* <img src="/eco-city-bg.jpg" alt="Eco Smart City" className="w-full" /> */}
//           {/* <img src={ecoCity} alt="Eco Smart City" className="w-full" /> */}
//         </div>

//         {/* Buttons */}
//         <button className="w-full bg-green-700 text-white font-semibold py-3 rounded-xl hover:bg-green-800 transition duration-300">
//           Sign In
//         </button>

//         <button className="w-full bg-green-800 text-white font-semibold py-3 rounded-xl mt-4 hover:bg-green-900 transition duration-300">
//           Create Account
//         </button>
//       </div>
//     </div>
